...
async function AbeatsB(A, B) {
    const completion = await openai.chat.completions.create({
        messages: [{
            ...
            content: `
                - your behaviour:
                  Respond in JSON format with keys and boolean values for "answer" like { "answer": false, "draw": false, "reason": "explanation" }.
                  ...
                  An example response would be { "answer": true, "draw": true, "reason": "Both are equally matched in strength and abilities." }.
